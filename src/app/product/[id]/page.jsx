        ...
        <div className=''>
            <section className='bg-white mb-10'>
                <section className='container-width px-3 md:px-6 py-12 flex flex-col md:flex-row items-start gap-8 font-poppins'>
                    <div>
                        <Image src={product?.images[0]} alt={product?.title} height={500} width={500} loading='lazy' />
                        <div className='flex items-center gap-4'>
                            {
                                product?.images?.map((image, idx) => <Image
                                    key={idx}
                                    src={image}
                                    alt={product?.title}
                                    height={100}
                    ...
                    <div className='space-y-5'>
                        <h1 className='text-3xl text-[#151515] font-bold font-marvel'>{product?.title}</h1>
                        ...
                        <h1 className='font-bold text-3xl text-red-600'>{product?.currentPrice.toFixed(2)}৳
                            <span className='ms-3 line-through text-lg text-gray-600 font-semibold'>{product?.originalPrice.toFixed(2)}৳</span>
                        </h1>
                    </div>
                </section>
            </section>
